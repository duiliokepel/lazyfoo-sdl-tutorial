...
int get_car_heading_index(const double heading_angle, int* index,
                          SDL_RendererFlip* flip);
int get_animation_state(const struct timespec* start_time,
...
int init_SDL(struct sdl_system* system) {
    ...
    system->window = SDL_CreateWindow(
        "SDL Tutorial 15 - Rotation and Flipping", SDL_WINDOWPOS_UNDEFINED,
...
int load_media(struct sdl_data* data, SDL_Renderer* renderer) {
    ...
    data->blue_falcon_clips[3] =
        (SDL_Rect){.x = 148, .y = 18, .w = 48, .h = 32};
    data->blue_falcon_clips[4] =
        (SDL_Rect){.x = 197, .y = 18, .w = 48, .h = 32};
    data->blue_falcon_clips[5] =
        (SDL_Rect){.x = 246, .y = 18, .w = 48, .h = 32};
    data->blue_falcon_clips[6] =
        (SDL_Rect){.x = 295, .y = 18, .w = 48, .h = 32};
    data->blue_falcon_clips[7] =
        (SDL_Rect){.x = 344, .y = 18, .w = 48, .h = 32};
    data->blue_falcon_clips[8] =
        (SDL_Rect){.x = 393, .y = 18, .w = 48, .h = 32};
    data->blue_falcon_clips[9] =
        (SDL_Rect){.x = 442, .y = 18, .w = 48, .h = 32};
    data->blue_falcon_clips[10] =
        (SDL_Rect){.x = 491, .y = 18, .w = 48, .h = 32};
    data->blue_falcon_clips[11] =
        (SDL_Rect){.x = 540, .y = 18, .w = 48, .h = 32};
    data->blue_falcon_clips[12] =
        (SDL_Rect){.x = 589, .y = 18, .w = 48, .h = 32};
    ...
    data->golden_fox_clips[3] =
        (SDL_Rect){.x = 148, .y = 324, .w = 48, .h = 32};
    data->golden_fox_clips[4] =
        (SDL_Rect){.x = 197, .y = 324, .w = 48, .h = 32};
    data->golden_fox_clips[5] =
        (SDL_Rect){.x = 246, .y = 324, .w = 48, .h = 32};
    data->golden_fox_clips[6] =
        (SDL_Rect){.x = 295, .y = 324, .w = 48, .h = 32};
    data->golden_fox_clips[7] =
        (SDL_Rect){.x = 344, .y = 324, .w = 48, .h = 32};
    data->golden_fox_clips[8] =
        (SDL_Rect){.x = 393, .y = 324, .w = 48, .h = 32};
    data->golden_fox_clips[9] =
        (SDL_Rect){.x = 442, .y = 324, .w = 48, .h = 32};
    data->golden_fox_clips[10] =
        (SDL_Rect){.x = 491, .y = 324, .w = 48, .h = 32};
    data->golden_fox_clips[11] =
        (SDL_Rect){.x = 540, .y = 324, .w = 48, .h = 32};
    data->golden_fox_clips[12] =
        (SDL_Rect){.x = 589, .y = 324, .w = 48, .h = 32};
    ...
    data->wild_goose_clips[3] =
        (SDL_Rect){.x = 148, .y = 642, .w = 48, .h = 32};
    data->wild_goose_clips[4] =
        (SDL_Rect){.x = 197, .y = 642, .w = 48, .h = 32};
    data->wild_goose_clips[5] =
        (SDL_Rect){.x = 246, .y = 642, .w = 48, .h = 32};
    data->wild_goose_clips[6] =
        (SDL_Rect){.x = 295, .y = 642, .w = 48, .h = 32};
    data->wild_goose_clips[7] =
        (SDL_Rect){.x = 344, .y = 642, .w = 48, .h = 32};
    data->wild_goose_clips[8] =
        (SDL_Rect){.x = 393, .y = 642, .w = 48, .h = 32};
    data->wild_goose_clips[9] =
        (SDL_Rect){.x = 442, .y = 642, .w = 48, .h = 32};
    data->wild_goose_clips[10] =
        (SDL_Rect){.x = 491, .y = 642, .w = 48, .h = 32};
    data->wild_goose_clips[11] =
        (SDL_Rect){.x = 540, .y = 642, .w = 48, .h = 32};
    data->wild_goose_clips[12] =
        (SDL_Rect){.x = 589, .y = 642, .w = 48, .h = 32};

    data->fire_stingray_clips[0] =
        (SDL_Rect){.x = 1, .y = 945, .w = 48, .h = 32};
    data->fire_stingray_clips[1] =
        (SDL_Rect){.x = 50, .y = 945, .w = 48, .h = 32};
    data->fire_stingray_clips[2] =
        (SDL_Rect){.x = 99, .y = 945, .w = 48, .h = 32};
    data->fire_stingray_clips[3] =
        (SDL_Rect){.x = 148, .y = 945, .w = 48, .h = 32};
    data->fire_stingray_clips[4] =
        (SDL_Rect){.x = 197, .y = 945, .w = 48, .h = 32};
    data->fire_stingray_clips[5] =
        (SDL_Rect){.x = 246, .y = 945, .w = 48, .h = 32};
    data->fire_stingray_clips[6] =
        (SDL_Rect){.x = 295, .y = 945, .w = 48, .h = 32};
    data->fire_stingray_clips[7] =
        (SDL_Rect){.x = 344, .y = 945, .w = 48, .h = 32};
    data->fire_stingray_clips[8] =
        (SDL_Rect){.x = 393, .y = 945, .w = 48, .h = 32};
    data->fire_stingray_clips[9] =
        (SDL_Rect){.x = 442, .y = 945, .w = 48, .h = 32};
    data->fire_stingray_clips[10] =
        (SDL_Rect){.x = 491, .y = 945, .w = 48, .h = 32};
    data->fire_stingray_clips[11] =
        (SDL_Rect){.x = 540, .y = 945, .w = 48, .h = 32};
    data->fire_stingray_clips[12] =
        (SDL_Rect){.x = 589, .y = 945, .w = 48, .h = 32};
...
int get_car_heading_index(const double heading_angle, int* index,
    ...
    ASSERT (flip != NULL, "Argument flip must not be NULL") { return -1; }
    ...
    if (index_offset > 12) { index_offset = 12; }
...
int get_animation_state(const struct timespec* start_time,
    ...
    ASSERT (car_state != NULL, "Argument car_state must not be NULL") {
        return -1;
    }
    ...
    for (counter = 0; counter < 5; counter++) {
        ...
        car_state->pos_x[counter] =
            (int)lround(radius * cos(t * 2.0 * M_PI + angle_offset) + center_x -
                        sprite_offset_x);
        car_state->pos_y[counter] =
            (int)lround(radius * sin(t * 2.0 * M_PI + angle_offset) + center_y -
                        sprite_offset_y);
        ...
        return_code = get_car_heading_index(heading_angle,
                                            &car_state->sprite_index[counter],
                                            &car_state->flip[counter]);
        ASSERT (return_code == 0, "get_car_heading_index error") { return -1; }
    }
...
int main_loop(const struct sdl_system system, const struct sdl_data data) {
    ...
    while (quit == false) {
        ...
        // Render textures
        return_code =
            render_texture(data.snes_fzero_racers, system.renderer,
                           car_state.pos_x[0], car_state.pos_y[0],
                           &data.blue_falcon_clips[car_state.sprite_index[0]],
                           0.0, NULL, car_state.flip[0]);
        ASSERT (return_code == 0, "render_texture error") { return -1; }

        return_code =
            render_texture(data.snes_fzero_racers, system.renderer,
                           car_state.pos_x[1], car_state.pos_y[1],
                           &data.golden_fox_clips[car_state.sprite_index[1]],
                           0.0, NULL, car_state.flip[1]);
        ASSERT (return_code == 0, "render_texture error") { return -1; }

        return_code =
            render_texture(data.snes_fzero_racers, system.renderer,
                           car_state.pos_x[2], car_state.pos_y[2],
                           &data.wild_goose_clips[car_state.sprite_index[2]],
                           0.0, NULL, car_state.flip[2]);
        ASSERT (return_code == 0, "render_texture error") { return -1; }

        return_code =
            render_texture(data.snes_fzero_racers, system.renderer,
                           car_state.pos_x[3], car_state.pos_y[3],
                           &data.fire_stingray_clips[car_state.sprite_index[3]],
                           0.0, NULL, car_state.flip[3]);
        ASSERT (return_code == 0, "render_texture error") { return -1; }

        return_code = render_texture(
            data.snes_fzero_racers, system.renderer, car_state.pos_x[4],
            car_state.pos_y[4], &data.snail_clips[car_state.sprite_index[4]],
            0.0, NULL, car_state.flip[4]);
        ASSERT (return_code == 0, "render_texture error") { return -1; }

        return_code = render_texture(data.snes_fzero_racers, system.renderer,
                                     296, 224, &data.blue_falcon_clips[0],
