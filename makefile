...
# file generated by bear
COMPILE_DB := compile_commands.json

# source files to be formatted by clang-format
FMT_FILES := $(SRC_DIR)/*.c $(SRC_DIR)/*.h
...
$(COMPILE_DB):
	@$(call PRINT_RULE)
	$(BEAR) -- $(MAKE) -B --no-print-directory $(PROGRAMS)
...
clean:
	@$(call PRINT_RULE)
	rm -rfv $(DEPS_DIR) $(BUILD_DIR) $(INCLUDE_DIR) $(EMBED_DIR) $(BIN_DIR) $(COMPILE_DB)
