...
12_color_modulation_OBJS = $(BUILD_DIR)/12_color_modulation.o \
	$(BUILD_DIR)/trace.o $(BUILD_DIR)/assert.o $(EMBED_DIR)/color_modulation.png.o
12_color_modulation_LIBS = -lSDL2 -lSDL2_image
